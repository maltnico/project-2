                ...
                {filteredUsers.map((user, index) => (
                  <tr 
                    ...
                    className={`hover:bg-gray-50 animate-in fade-in-0 slide-in-from-bottom-4 duration-500 ${
                      user.email === 'maltese.jean@free.fr' ? 'bg-yellow-50 border-l-4 border-yellow-400' : ''
                    }`}
        ...
        {filteredUsers.length === 0 && (
          <div className="text-center py-16 animate-in fade-in-0 slide-in-from-bottom-4 duration-500">
            ...
            <p className="text-gray-500 mb-8 max-w-md mx-auto">
              {searchTerm
                ? `Aucun utilisateur ne correspond à votre recherche "${searchTerm}". Essayez avec d'autres mots-clés.`
